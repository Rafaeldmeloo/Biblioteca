...
class Clientes
{
    public:
        ...
        virtual int ExcluirEmprestimo(std::string procuraL, std::string procuraN, std::string cidade) = 0;
        virtual bool AlterarEmprestimo(std::string procuraL, std::string procuraN, std::string cidade) = 0;
