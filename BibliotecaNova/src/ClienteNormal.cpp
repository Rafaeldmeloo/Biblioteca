...
int ClienteNormal::ExcluirEmprestimo(std::string procuraL, std::string procuraN, std::string cidade){
    setlocale(LC_ALL, "Portuguese");
    int exclusao = -1;

    if(emprestimo.getLivros().find(procuraL) != std::string::npos && emprestimo.getNomes().find(procuraN) != std::string::npos && cidade == emprestimo.getCidade())
        exclusao = 1;
...
bool ClienteNormal::AlterarEmprestimo(std::string procuraL, std::string procuraN, std::string cidade){
    setlocale(LC_ALL, "Portuguese");
    int alterar = -1;
